...
⚠️ COPIED VERBATIM from `benchmarks/omr-roster-wholework-2026-09/probe/` (branch
`claude/roster-wholework-2026-09`), so this workstream's headline is scored by
the SAME harness and the same hand-read lineups that measured the bug. Do not
edit it here — a divergent copy would make the two numbers incomparable.
