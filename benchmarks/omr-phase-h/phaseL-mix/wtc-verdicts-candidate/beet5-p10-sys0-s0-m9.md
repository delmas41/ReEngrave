...
# Cell beet5-p10-sys0-s0-m9 — verdicts

**Image:** ![overlay](../overlays/beet5-p10-sys0-s0-m9.png)

**Clef assumed:** treble

**Staff lines (canonical y):** 319, 402, 521, 621, 719

**Source:** beet5-p10  ·  page 10  ·  sys 0  staff 0  measure 9


## Detections

- [x] D0  noteheadBlackOnLine (notehead) at (x=51, y=1113)  conf=0.20
