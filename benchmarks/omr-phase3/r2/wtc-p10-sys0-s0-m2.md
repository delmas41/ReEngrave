...
- [x] D0  beam (unknown) at (x=62, y=398)  conf=0.59
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D1  beam (unknown) at (x=284, y=499)  conf=0.30
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D2  beam (unknown) at (x=428, y=398)  conf=0.60
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D3  beam (unknown) at (x=713, y=501)  conf=0.27
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D4  beam (unknown) at (x=942, y=398)  conf=0.55
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D5  beam (unknown) at (x=1443, y=398)  conf=0.65
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D6  beam (unknown) at (x=1538, y=802)  conf=0.38
       verdict: __________  <!-- new detection, no baseline match -->
