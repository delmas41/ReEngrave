...
- [x] D0  coda (unknown) at (x=61, y=346)  conf=0.31
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D1  coda (unknown) at (x=62, y=448)  conf=0.68
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D2  beam (unknown) at (x=240, y=399)  conf=0.55
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D3  coda (unknown) at (x=707, y=345)  conf=0.42
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D4  beam (unknown) at (x=724, y=398)  conf=0.30
       verdict: __________  <!-- new detection, no baseline match -->
