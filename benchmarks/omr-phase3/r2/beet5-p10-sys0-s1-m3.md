...
- [x] D0  noteheadBlackInSpace (notehead) at (x=12, y=18)  conf=0.32
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D1  noteheadBlackOnLine (notehead) at (x=16, y=550)  conf=0.43
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D2  beam (unknown) at (x=659, y=731)  conf=0.40
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D3  beam (unknown) at (x=1561, y=725)  conf=0.26
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D4  beam (unknown) at (x=1798, y=451)  conf=0.31
       verdict: __________  <!-- new detection, no baseline match -->
