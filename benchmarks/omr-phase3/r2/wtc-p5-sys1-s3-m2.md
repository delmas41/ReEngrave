...
# Cell wtc-p5-sys1-s3-m2 — verdicts
...
**Source:** wtc-p5  ·  page 5  ·  sys 1  staff 3  measure 2


## Detections

- [x] D0  beam (unknown) at (x=198, y=502)  conf=0.57
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D1  coda (unknown) at (x=447, y=450)  conf=0.31
       verdict: __________  <!-- new detection, no baseline match -->
- [x] D2  beam (unknown) at (x=644, y=705)  conf=0.48
       verdict: __________  <!-- new detection, no baseline match -->
