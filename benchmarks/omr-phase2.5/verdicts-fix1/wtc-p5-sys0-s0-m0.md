...
- [x] D0  flag8thUp (flag) at (x=57, y=389)  conf=0.64
       verdict: FP clef-body  <!-- ported from baseline D0 -->
- [x] D1  noteheadBlack (notehead) at (x=76, y=427) → C4  conf=0.72
       verdict: FP clef-tail  <!-- ported from baseline D1 -->
- [x] D2  noteheadBlack (notehead) at (x=102, y=136) → A5  conf=0.64
       verdict: FP clef-curl  <!-- ported from baseline D2 -->
- [x] D3  flag16thUp (flag) at (x=106, y=286)  conf=0.66
       verdict: FP clef-inner  <!-- ported from baseline D3 -->
- [x] D4  rest8th (rest) at (x=311, y=444)  conf=0.86
       verdict: unsure rest-or-flag  <!-- ported from baseline D4 -->
- [x] D5  restHalf (rest) at (x=320, y=242)  conf=0.60
       verdict: FP stem-of-quarter  <!-- ported from baseline D5 -->
