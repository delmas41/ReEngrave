...
- [ ] D0  noteheadBlack (notehead) at (x=320, y=196) → A3  conf=0.88
       verdict: __________
- [ ] D1  noteheadBlack (notehead) at (x=323, y=366) → A2  conf=0.80
       verdict: __________
- [ ] D2  noteheadBlack (notehead) at (x=681, y=365) → A2  conf=0.66
       verdict: __________
- [ ] D3  rest8th (rest) at (x=681, y=199)  conf=0.83
       verdict: __________
- [ ] D4  noteheadBlack (notehead) at (x=876, y=221) → G3  conf=0.80
       verdict: __________
- [ ] D5  flag8thUp (flag) at (x=894, y=159)  conf=0.87
       verdict: __________
- [ ] D6  noteheadBlack (notehead) at (x=1067, y=196) → A3  conf=0.88
       verdict: __________
- [ ] D7  noteheadBlack (notehead) at (x=1259, y=171) → B3  conf=0.85
       verdict: __________
- [ ] D8  noteheadBlack (notehead) at (x=1565, y=148) → C4  conf=0.86
       verdict: __________
- [ ] D9  noteheadBlack (notehead) at (x=1868, y=119) → D4  conf=0.75
       verdict: __________
- [ ] D10  noteheadBlack (notehead) at (x=1970, y=148) → C4  conf=0.86
       verdict: __________
