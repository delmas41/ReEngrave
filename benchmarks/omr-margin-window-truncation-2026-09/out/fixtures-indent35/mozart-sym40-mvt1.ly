...
\version "2.24.4"
% automatically converted by musicxml2ly from benchmarks/omr-margin-window-truncation-2026-09/out/fixtures-indent35/mozart-sym40-mvt1.musicxml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative c' {
    ...
    R1*5 ^\markup{ \bold {Allegro molto.} } }
...
PartPSevenVoiceOne =  \relative es'' {
    ...
    \stemDown c4 -_ \stemDown c4 r4 \stemDown d8 ( [ \stemDown c8 ) ] }
...
PartPEightVoiceOne =  \relative es' {
    ...
    es8 ( [ \stemUp d8 ) ] | % 5
    \stemUp c4 -_ \stemUp c4 r4 \stemUp d8 ( [ \stemUp c8 ) ] }
