...
\version "2.24.4"
% automatically converted by musicxml2ly from benchmarks/omr-margin-window-truncation-2026-09/out/fixtures-indent35/bruckner-sym5-mvt1.musicxml
\pointAndClickOff
...
PartPOneThreeVoiceOne =  \relative c' {
    \clef "treble" \time 2/2 \key f \major \transposition bes | % 1
    R1*7 }
...
PartPTwoTwoVoiceOne =  \relative c' {
    ...
    \stemUp d2 _\pp \stemUp d2 ^> _\sf }

PartPTwoTwoVoiceOneLyricsOne =  \lyricmode {\set ignoreMelismata = ##t
    a\skip1 \skip1 \skip1 \skip1 \skip1
    }
...
PartPTwoThreeVoiceOne =  \relative bes {
    ...
    \stemUp f2 _\pp \stemUp es2 ~ ^> _\sf }
