...
\version "2.24.4"
% automatically converted by musicxml2ly from benchmarks/omr-margin-window-truncation-2026-09/out/fixtures-indent35/brahms-sym4-mvt1.musicxml
\pointAndClickOff
...
PartPOneVoiceOne =  \relative b'' {
    ...
    r4 \stemDown dis4 ( -. r4 \stemDown b'4 ) -. }
...
PartPTwoVoiceOne =  \relative g'' {
    ...
    r4 \stemDown b4 ( -. r4 \stemDown g'4 ) -. }
...
PartPFiveVoiceOne =  \relative d'' {
    ...
    r4 \stemUp fis4 ( -. r4 \stemDown d'4 ) -. }
...
PartPSixVoiceOne =  \relative bes' {
    ...
    r4 \stemUp d4 ( -. r4 \stemDown bes'4 ) -. }
...
PartPOneSixVoiceOne =  \relative b'' {
    ...
    \stemDown b'2 ) r4 \stemDown e4 ( _\> _\! }

PartPOneSixVoiceOneLyricsOne =  \lyricmode {\set ignoreMelismata = ##t
    a\skip1 \skip1 \skip1 \skip1 \skip1 \skip1 \skip1 a
    }
...
PartPOneSevenVoiceOne =  \relative b' {
    ...
    \stemDown b'2 ) r4 \stemDown e4 ( _\> _\! _\! }
