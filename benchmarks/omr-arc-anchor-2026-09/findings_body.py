"""Write this round's FINDINGS.md (the repo's benchmark-record convention).
Kept as a script so the document can be regenerated with the e2e sections
filled in once the arms land."""
from pathlib import Path

BODY = r"""# Arc anchors — round 9: an arc is kept by what it connects
