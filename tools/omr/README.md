...
peaks). Pass `--imgsz N` to pin a value; `--imgsz 2048` reproduces the old
behaviour.
...
| Reproduce pre-2026-08-28 output exactly | `--imgsz 2048` (see "Inference scale" — it over-counts notes ~2x) |
