...
def _flatten_run(staves: list[dict[str, Any]]) -> tuple[
    ...
    return measures, spacings, tops, frozenset(breaks)
...
def _pair_slurs_in_run(staves: list[dict[str, Any]]) -> int:
    ...
    measures, spacings, tops, breaks = _flatten_run(staves)
    if not measures:
        return 0
    ...
    spans = _paired_spans(measures, per_measure_arcs, spacings, tops, breaks,
                          _voice_of_notehead(measures))
    n_marked = 0
