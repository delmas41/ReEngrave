...
def detect_staves(page: PageImage) -> PageWithStaves:
    ...
    # gap-size heuristic below is the fallback for pages whose barlines and
    # bracket are too faint to see at all — on a conductor's score it splits
    # at bracket-GROUP gaps and reports one system as several. See
