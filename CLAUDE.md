...
| `OMR_SLOT_STITCH` | `0` off (default) → join staves into parts by contextual SLOT where the ordinal join refuses. Measured; it has never scored worse (−240 raw / −2,278 page-normalised, re-priced 2026-09-07) and is dormant because the evidence is 2 distinct pages of one structural shape. See the knobs table. |
