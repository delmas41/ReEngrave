...
Current on the engraved orchestral benchmark, measured on `d112052`: **pooled 0.1242 / 889 edits** (Mahler 0.0395, Beethoven 0.1519, Brahms 0.1556), over 3696 truth + 3464 predicted symbols, from an opening baseline of 0.3164 on 2026-08-31. With `--direction-text` (off by default, needs `.venv-surya`), **0.1116 / 808**, measured on `e78e8f3`.
