...
mechanism can be wrong about*. ⚠️ Its one claim that is now SUPERSEDED, and
only this one: the case that separates them (a movement boundary on a page that
READS WELL) is no longer unmeasured — see the handoff above.
