...
glyph. **§5 ranks the next work: a second document and publisher is now the
only thing between the carry and a default**, then two carry-source gaps found
and deliberately not built. Its predecessor
