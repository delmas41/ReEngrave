...
| `OMR_CHOIR_GROUPING` | `0` off (default) → candidate cues for choir-barred / differently-indented pages (pair-local left-edge merge + grouped-system open-score guard); `1` enables. Flag off is byte-identical. See the knobs table. |
