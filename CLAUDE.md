...
- **Clef coverage is ~20% on 19th-century prints, though reading is reliable.** On Nottebohm, clefs are read on 268 of 1366 music staves; the CV locator supplies 204 of those (all C clefs the detector cannot see at any confidence) against the detector's 64. Where a clef is read it is essentially always right (7/7 on the hand-checked ground-truth page). The remaining 80% carry an inherited or defaulted clef, and the limiter is upstream — the clef falling outside its cell, or fusing into neighbouring ink.
